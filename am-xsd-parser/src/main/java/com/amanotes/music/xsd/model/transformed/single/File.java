    ...
    extends AudibleMagicEntity
{
    ...
    private String name;
    @XmlElement(name = "File-Size", nillable = false, required = false, namespace = "##default", type = javax.xml.bind.annotation.XmlElement.DEFAULT.class)
    private BigInteger fileSize;
    @XmlElement(name = "Video-Size", nillable = false, required = false, namespace = "##default", type = javax.xml.bind.annotation.XmlElement.DEFAULT.class)
    private String videoSize;
    @XmlElement(name = "Bit-Rate", nillable = false, required = false, namespace = "##default", type = javax.xml.bind.annotation.XmlElement.DEFAULT.class)
